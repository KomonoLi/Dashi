...
public class DBYelpImport {
	 //create three tables in db
	 //想重头再来的时候，才需要都删掉，重新开始，删掉table里面所有的信息
	 //只是需要reset才用这个
	public static void main(String[] args) { //可以运行main函数，把之前的table 都drop掉 drop table exist 
	   	 try {
	         // Ensure the driver is imported.
	   		 Class.forName("com.mysql.jdbc.Driver").newInstance();
	   		 Connection conn = null; //conn DBUtil 里面的 url
